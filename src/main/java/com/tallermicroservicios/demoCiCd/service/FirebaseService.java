...
public class FirebaseService {
	...
	public String registrarBeacon(Beacon beacon) throws InterruptedException, ExecutionException {
		Firestore dbFirestore = FirestoreClient.getFirestore();
		ApiFuture<WriteResult> collectionsApiFuture = dbFirestore.collection("beacons").document(beacon.getUID()).set(beacon);
		return collectionsApiFuture.get().getUpdateTime().toString();
